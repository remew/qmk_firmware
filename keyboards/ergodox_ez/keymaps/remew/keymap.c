 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      | LGui |MHEN/LAlt|                                 |HENK/RAlt| RGui |      |      |      |
 *   `-------------------------------------'                                 `-------------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      | Esc  |
 *                               ,--------|------|------|       |------+------+--------.
 *                               |        |      |      |       |      |      |        |
 *                               |L3/Space|Backsp|------|       |------| Tab  | Enter  |
 *                               |        |ace   | Del  |       | Ins  |      |        |
 *                               `----------------------'       `----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LCTRL,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,
         ...
         _______, _______, _______, KC_LGUI, MT(KC_RALT, KC_MHEN),
                                                      _______, _______,
                                                               _______,
                                     LT(MDIA,KC_SPC), KC_BSPC,  KC_DEL,
        ...
        KC_RBRC,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,
                          MT(KC_RALT, KC_HENK), KC_RGUI, _______, _______, _______,
        _______,  KC_ESC,
        _______,
...
[MDIA] = KEYMAP(
    ...
    // right hand
       _______, _______, _______, _______, _______, _______, _______,
       _______, KC_PSCR, KC_PGDN, KC_PGUP, _______, _______, _______,
                KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, _______,
       _______, KC_WSCR, _______, _______, _______, _______, _______,
